...
\subsection{Response Time Data—participants grouped by Orthographic Sensitivity}
...
\subsection{Response Time Data—participants grouped by language proficiency}
...
\subsection{Summary of RT Results}
	\paragraph{Summary of Response Time Results (Orthographic Sensitivity)}
	...
	\paragraph{Summary of Response Time Results (Language Proficiency)}
...
\subsection{ERP Data——participants grouped by Orthographic Sensitivity}
...
The present findings demonstrate that morphological structure influences both word recognition and nonword rejection, providing converging evidence for early, automatic morphological decomposition during visual word processing. Across tasks and participant groups, morphologically complex nonwords (e.g., *gasful*) were rejected more slowly than orthographically matched but morphologically simple nonwords (e.g., *gasfil*), confirming the morpheme interference effect. This pattern indicates that recognition processes automatically engage morphemic representations even when no real lexical entry exists, consistent with form-driven decomposition accounts of lexical access (Rastle et al., 2004; McCormick et al., 2009). The presence of recognizable morphemes appears to activate lexical-level representations that must subsequently be inhibited once nonword status is detected, thereby delaying response times.

For real words, both base frequency and morphological family size independently facilitated recognition, with faster responses to words derived from high-frequency bases and to words belonging to large morphological families. These additive effects suggest that base-level and family-level characteristics contribute separately to recognition speed, consistent with distributed models of morphological processing in which morphemic activation and semantic network richness each enhance lexical access (Baayen et al., 2006). High base frequency likely strengthens morphemic representations, while large family size promotes coactivation within semantically related networks.

In contrast, for nonwords, morphological structure increased processing time rather than facilitating it. Complex nonwords were consistently slower than simple ones, and items derived from high-frequency bases produced the longest latencies. This reversal underscores the automaticity of morphological parsing: familiar morphemes trigger activation of lexical candidates that cannot be resolved, thereby prolonging rejection. Such interference supports the view that morphological analysis precedes lexical decision and operates even in the absence of semantic confirmation.

Individual differences further shaped performance. Participants with higher orthographic sensitivity responded faster overall, indicating greater efficiency in processing visually structured input, though sensitivity did not strongly modulate the size of lexical or morphological effects. Language proficiency, by contrast, selectively magnified the cost of morphological complexity for nonwords with large family sizes—an effect suggesting that more proficient readers engage more deeply in morphological parsing when confronted with pseudo-morphological structure. These patterns align with experience-based models of reading (Perfetti, 2007; Nation, 2005), in which extensive linguistic experience heightens sensitivity to sublexical regularities and deepens the interplay between form and meaning.

Together, these findings reinforce three central conclusions. First, morphological decomposition is an early and largely obligatory process in visual word recognition, operating automatically on any string containing recognizable morphemic structure. Second, the consequences of decomposition diverge by lexical status—facilitatory for real words but inhibitory for morphologically structured nonwords. Third, reader-specific factors modulate the extent and depth of this decomposition: orthographic expertise enhances general fluency, whereas higher language proficiency increases morphological engagement, especially in challenging, nonlexical contexts. These results highlight the need for models of lexical access that incorporate both item-level properties and individual differences in reading skill, situating morphological processing within a dynamic, reader-specific framework.

...
The asymmetric interaction structure reflected in Table~1 warrants brief explanation. For word stimuli, the N250 model tested the interaction between Family Size and Orthographic Sensitivity only, consistent with the prediction that early form-based processing is selectively modulated by sublexical orthographic knowledge; Language Proficiency was included as a covariate. The N400 model for words reversed this structure, testing the interaction between Family Size and Language Proficiency, with Orthographic Sensitivity as a covariate. For nonword stimuli, the N250 model tested interactions between Complexity and both individual difference dimensions, reflecting the expectation that novel forms, lacking stored whole-word representations, place greater simultaneous demands on both orthographic and semantic knowledge during early parsing. The N400 model for nonwords included the three-way Complexity $\times$ Family Size $\times$ LP interaction as its primary test, consistent with the prediction that Language Proficiency specifically governs how morphological family information is recruited during semantic integration; Orthographic Sensitivity was included as a main effect covariate. This structure ensures that each model is specified to answer a theoretically motivated question rather than exhaustively testing all possible interactions.
...
The ERP measures, which were designed to examine whether individual differences modulate morphological processing at distinct temporal stages, revealed systematic modulation that the RT models, specified to index overall efficiency rather than processing architecture, were not designed to detect. For words, Family Size robustly modulated both the N250 and N400, reflecting sensitivity to morphological family structure at early form-based and later semantic processing stages respectively. At the N250, the interaction between Family Size and Orthographic Sensitivity did not reach significance, though a marginal trend suggested that orthographic skill may modulate the sensitivity of early family size effects. At the N400, the interaction between Family Size and Language Proficiency was not significant, indicating that semantic integration of morphological family information for familiar words is robust and not selectively shaped by depth of lexical-semantic knowledge. An unexpected main effect of Orthographic Sensitivity at the N400 reflected overall differences in the efficiency of semantic access independently of morphological structure. For nonwords, individual differences interacted with morphological structure at both the N250 and N400, providing evidence that accumulated lexical experience shapes the dynamics of morphological processing in ways that response time alone cannot reveal.
